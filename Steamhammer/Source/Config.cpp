...
namespace Config
{
    namespace ConfigFile
    {
        ...
        std::string ConfigFileLocation      = "bwapi-data/AI/Cydonia.json";
    }
    ...
    namespace BotInfo
    {
        std::string BotName                 = "Cydonia";
        std::string Authors                 = "Cydonia";
    ...
    namespace Debug								
    {
        ...
        std::string ErrorLogFilename        = "Cydonia_ErrorLog.txt";
